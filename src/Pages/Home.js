    ...
    <Layout>
      <div className='HomePage'>
        ...
        <div className='HomeText'>
          <h1>Hi There!</h1>
          <h1>I'M <b>RAHUL SINGH & VINEET BHANDARI</b></h1>
          <Typed />
        </div>
      ...
      <div className='AboutPage'>
        <div className='AboutText'>
          ...
          <p>
            ...
            I am well-versed in <b>Web Development</b>. Currently, I am engaged in various projects that involve the use of Next.js, React, React-Admin, and React-Ionic.<br />
